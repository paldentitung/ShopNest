...
import { FaSignOutAlt, FaLock, FaEye, FaEyeSlash } from "react-icons/fa";
...
const AdminProfile = () => {
  ...
  const admin = JSON.parse(localStorage.getItem("ShopNest-user") || "{}");
          ...
          <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            ...
            <div className="px-8 py-7 flex flex-col sm:flex-row items-center sm:items-start gap-6 border-b border-gray-100">
              <div className="relative shrink-0">
                <div className="w-20 h-20 rounded-full border-2 border-gray-200 bg-indigo-100 flex items-center justify-center shrink-0">
