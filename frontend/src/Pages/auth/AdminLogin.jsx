...
const AdminLogin = () => {
  return (
    <section className="min-h-screen bg-(--color-background)  flex justify-center items-center">
      {/* wrapper */}
      <div className="bg-white w-full max-w-5xl mx-auto h-full max-h-120 rounded-2xl shadow p-8 flex gap-8  overflow-hidden ">
        <div className=" hidden md:flex flex-1 h-1/2  flex-col gap-10 overflow-hidden  ">
          <div className="font-bold text-lg text-center">
            Log in to manage products, orders, and store settings.{" "}
          </div>
          <div className="h-1/3">
            <img src="../login.svg" alt="" className="object-cover" />
          </div>
        </div>
